...
public class completedata extends javax.swing.JFrame {
    ...
    public void jTable1(){
        try{
            String sql="select shid'Hostel ID' ,sn'Student name',fn'Father name',mn'Mother name',address'Address',course'Course',year'Year',email'Email    ',mob'Mobile   ' from student";
